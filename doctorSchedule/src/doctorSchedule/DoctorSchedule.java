...
public class DoctorSchedule {
	...
	static TreeMap<String, Doctors> doctorAppointment = new TreeMap<>();
	...
	public static void docAppointment() {
		System.out.println("------------------------------------------------");
		System.out.println("Choose Number to see the Appointments of each Doctors");
		System.out.println("[1]" + doctorSchedule.get("1") + "\t" + "[2]" + doctorSchedule.get("2") + "\t" + "[3]"
				+ doctorSchedule.get("3") + "\t" + "[4]" + doctorSchedule.get("4"));
		String appointments = scn.next();
